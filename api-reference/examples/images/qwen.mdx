...
def generate_image_qwen(prompt, model="qwen-image-plus", size="1328*1328",
                       prompt_extend=True, negative_prompt=None, response_format="url"):
    """
    使用千问API生成图片
    ...
    if negative_prompt:
        data["qwen"]["negative_prompt"] = negative_prompt
...
def generate_image_qwen_advanced(prompt, **kwargs):
    ...
    data = {
        ...
        "size": kwargs.get("size", "1328*1328"),
    ...
    if kwargs.get("prompt_extend") is not None:
        qwen_params["prompt_extend"] = kwargs["prompt_extend"]
    if kwargs.get("negative_prompt"):
        qwen_params["negative_prompt"] = kwargs["negative_prompt"]
