...
| 模型 ID | 能力 | 时长 | 分辨率 | 帧率 |
|---------|------|------|--------|------|
| **doubao-seedance-2-0-260128** | 联网搜索、音画同生、图生视频、文生视频 | 5 秒 | 480p, 720p, 1080p | 24 fps |
...
| **resolution** | String | 否 | 分辨率等级：`480p`、`720p`、`1080p`（仅 Seedance 2.0 支持，由 size 自动映射） |
| **seconds** | String | 否 | 视频时长（秒），范围取决于模型：Seedance 2.0 支持 5 秒，1.0 支持 2~12秒，1.5 支持 4~12秒 |
